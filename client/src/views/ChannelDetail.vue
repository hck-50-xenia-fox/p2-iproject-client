...
export default {
    ...
    methods: {
        ...mapActions(useCounterStore, ["getChannelDetail", "getChannelVideos"])
    },
    computed: {
        ...mapState(useCounterStore, ["dataChannelDetail", "dataChannelVideos"])
    },
    created() {
        this.getChannelVideos(this.$route.params.id)
        this.getChannelDetail(this.$route.params.id)
    }
}
</script>
<template>
    ...
    <section class="channel-info">
        ...
        <div class="container">
            ...
            <div class="channel-icon">
                <img :src="dataChannelDetail.avatar" alt="">

            </div>

            <div class="channel-title">

                <h1>{{dataChannelDetail.title}} <i class="fas fa-check-circle"></i></h1>

                <div class="channel-subscriber-count">{{dataChannelDetail.subscribers}}</div>

            </div>

            <div class="channel-subscribe">

                <button class="subscribe-btn btn">{{dataChannelDetail.subscribers}}</button>

                <button class="notification-btn btn" aria-label="Enable Notifications"><i class="fas fa-bell"
        ...
        <div class="container">
            ...
            <section class="channel-videos">
                ...
                <div class="featured-video">
                    ...
                    <div class="video-info">
                        <ul class="video-meta-data">
                            <li class="video-creator">{{dataChannelDetail.country}}, <i class="fas fa-check-circle"></i>
                            </li>
                            <li class="video-views">{{dataChannelDetail.views}} Views</li>
                            <li class="video-upload-date">{{dataChannelDetail.joinDate}}</li>
                        </ul>
                        <p class="video-description">{{dataChannelDetail.description}}</p>
                    </div>
                ...
                <div class="vlogs-playlist playlist">
                    ...
                    <h2 class="playlist-title">Videos</h2>

                    <div class="playlist-videos">

                        <div class="playlist-video" tabindex="0" v-for="video in dataChannelVideos">

                            <div class="video-thumbnail">
                                <img :src="video.thumbnailUrl" alt=""
                                    @click.prevent="this.$router.push(`/detail/${video.videoId}`)">
                            </div>
            ...
            <section class="recommended-channels">
                ...
                <div class="recommended-channels-group">
                    ...
                    <div class="recommended-channel">
                        ...
                        <div class="recommended-channel-icon">
                            <img src="https://images.unsplash.com/photo-1516257984-b1b4d707412e?w=24&h=24&fit=crop&crop=faces"
                                alt="">
                        </div>

                        <h3 class="recommended-channel-title">Withered Flower</h3>
                    ...
                    <div class="recommended-channel">
                        ...
                        <div class="recommended-channel-icon">
                            <img src="https://s3-ap-southeast-1.amazonaws.com/loket-production-sg/images/organization/20211104152816_618399a02ea30.jpg"
                                alt="">
                        </div>

                        <h3 class="recommended-channel-title">Hacktiv 8</h3>
                ...
                <div class="recommended-channels-group">
                    ...
                    <div class="recommended-channel">
                        ...
                        <div class="recommended-channel-icon">
                            <img src="https://images.unsplash.com/photo-1469032923574-4f1413034019?w=24&h=24&fit=crop"
                                alt="">
                        </div>

                        <h3 class="recommended-channel-title">Wandi Ismail</h3>
                    ...
                    <div class="recommended-channel">
                        ...
                        <div class="recommended-channel-icon">
                            <img src="https://images.unsplash.com/photo-1504960868016-9a59a5172321?w=24&h=24&fit=crop"
                                alt="">
                        </div>

                        <h3 class="recommended-channel-title">Alex Chandra Hanif</h3>
                    ...
                    <div class="recommended-channel">
                        ...
                        <div class="recommended-channel-icon">
                            <img src="https://images.unsplash.com/photo-1472591651607-70e2d88ae3c4?w=24&h=24&fit=crop"
                                alt="">
                        </div>

                        <h3 class="recommended-channel-title">Adib Wafi</h3>
