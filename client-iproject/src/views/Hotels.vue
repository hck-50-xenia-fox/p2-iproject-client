...
export default {
  ...
  computed: {
    ...mapState(useStoreIndex, ["hotels", 'currentPage', 'covid19']),
  ...
  methods: {
    ...mapActions(useStoreIndex, ['listHotels']),
...
<template>
  ...
  <section id="hotels">
    ...
    <div class="container mb-4" style="margin-top: 3em">
      <div class="row">
        <CardHotel v-for="(hotel, index) in hotels" :key="index" :hotel="hotel" />
      </div>
    </div>
